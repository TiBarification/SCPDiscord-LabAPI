...
4. Turn off public status in the bot tab (**IMPORTANT! If anyone can add the bot they can use commands on your bot through their own server bypassing your permissions!**):
