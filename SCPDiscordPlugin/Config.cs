...
namespace SCPDiscord
{
	public static class Config
	{
		...
		private static readonly Dictionary<string, string[]> configArrays = new Dictionary<string, string[]>
		{
			...
			{ "channels.oncallcommand.remoteadmin", new string[]{ } },
			{ "channels.oncallcommand.game",        new string[]{ } },
			{ "channels.oncallcommand.console",     new string[]{ } },
			{ "channels.onexecutedcommand.remoteadmin", new string[]{ } },
			{ "channels.onexecutedcommand.game",        new string[]{ } },
			{ "channels.onexecutedcommand.console",     new string[]{ } },
