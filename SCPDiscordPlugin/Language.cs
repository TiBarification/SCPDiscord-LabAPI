...
namespace SCPDiscord
{
	internal static class Language
	{
		...
		private static readonly List<string> messageNodes = new List<string>
		{
			...
			"player.oncallcommand.remoteadmin",
			"player.oncallcommand.game",
			"player.oncallcommand.console",
			"player.onexecutedcommand.remoteadmin",
			"player.onexecutedcommand.game",
			"player.onexecutedcommand.console",
			"player.onreload",
